...
let TopAppBar = class TopAppBar extends BaseElement {
    ...
    createAdapter() {
        return Object.assign({}, addHasRemoveClass(this.mdcRoot), { setStyle: (property, value) => this.mdcRoot.style.setProperty(property, value), getTopAppBarHeight: () => this.mdcRoot.clientHeight, 
...
__decorate([
    property({ type: Boolean, reflect: true })
], TopAppBar.prototype, "centerTitle", void 0);
